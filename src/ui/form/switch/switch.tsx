...
const track = tv({
  ...
  variants: {
    isSelected: {
      ...
      true: "bg-primary-700 forced-colors:!bg-[Highlight] group-pressed:bg-primary-800",
    },
    isDisabled: {
  ...
  return (
    <AriaSwitch
      ...
      className={composeTailwindRenderProps(
        props.className,
        "group flex items-center gap-2 text-sm text-gray-800 transition disabled:text-gray-400 forced-colors:disabled:text-[GrayText]",
      )}
    >
      {(renderProps) => (
        <>
